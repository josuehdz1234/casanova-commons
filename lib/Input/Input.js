...
var _excluded = ["className", "id", "name", "label", "right", "left", "placeholder", "onChange", "inputClass", "modifiedExternal", "showLabel", "deleteValue", "onDeleteValue", "initialValue", "defaultValue"];
...
var Input = /*#__PURE__*/_react["default"].forwardRef(function (props, ref) {
  var className = props.className,
    ...
    modifiedExternal = props.modifiedExternal,
  ...
  var hasValue = typeof field.value !== 'undefined' && field.value !== '';
  var icn = (0, _react.useMemo)(function () {
    var inputClassName = (0, _classnames["default"])("".concat(inputClass && 'formtopPosition', " form-control"), (hasContent || modifiedExternal || hasValue) && 'form-control--with-content', hasError && 'is-invalid', right && 'input-group-br-no', left && 'input-group-bl-no');
  ...
  return /*#__PURE__*/_react["default"].createElement("div", {
    ...
    style: {
      visibility: "".concat(hasError || hasContent || modifiedExternal || hasValue || showLabel ? 'visible' : 'hidden')
    },
