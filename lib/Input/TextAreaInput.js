...
var _excluded = ["regex", "className", "id", "name", "label", "placeholder", "rows", "onlyError", "onChangeWithRegex"];
...
function TextAreaInput(props) {
  var regex = props.regex,
    ...
    onChangeWithRegex = props.onChangeWithRegex,
  ...
  var handleChange = (0, _react.useCallback)(function (e) {
    ...
    var clean = value.replace(whiteSpaceRegex, ' ');
    setValue(clean);
    if (onChangeWithRegex) {
      onChangeWithRegex(clean);
    }
  }, [setValue, onChangeWithRegex]);
  var hasNotValue = typeof field.value === 'undefined' || field.value === '';
  var hasValue = field.value && field.value !== '';
  var hasError = onlyError ? error : touched && error;
  var icn = (0, _classnames["default"])('form-control', hasError && 'is-invalid', hasValue && 'with-content');
  var row = rows || '5';
